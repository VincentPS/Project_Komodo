...
<body>
	<section class="canvas">
		<canvas id="main">Your browser may not support the HTML5 canvas element. Consider upgrading to a browser which does, such as: Google Chrome or Mozilla Firefox.</canvas>
	</section>
